// The machine's power supply (chalkwalk/dsp/PowerSupply.h, SOURCES section 21).
//
...
#include <chalkwalk/dsp/PowerSupply.h>
          ...
          "[supply][teeth]")
{
    ...
    // that.
    dsp::PowerSupply::Config shielding;
    shielding.humLine = 0.01;

    dsp::PowerSupply::Config reservoir;
